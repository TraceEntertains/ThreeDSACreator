...
namespace ThreeDSACLib.FRD
{
    ...
    {
        public static readonly uint FRIEND_SCREEN_NAME_SIZE = 0xB;            ///< 11-short UTF-16 screen name
        public static readonly uint FRIEND_COMMENT_SIZE = 0x11;               ///< 17-short UTF-16 comment
        public static readonly uint FRIEND_GAME_MODE_DESCRIPTION_SIZE = 0x80; ///< 128-short UTF-16 description
        public static readonly uint FRIEND_LIST_SIZE = 0x64;
        ...
        public char[] password = new char[0x20]; // NASC Password (found in friends list save maybe?)
        ...
        public Mii.ChecksummedMiiData my_mii_data;
        ...
        public byte[] Serialize(Dictionary<string, string> accountDatDict, string nascUrl)
        {
            // Handle mii data
            my_mii_data = new(Helpers.StringBytesToByteArray(accountDatDict["MiiData"]));
            my_screen_name = Helpers.StringBytesToUShortArray(accountDatDict["MiiName"]);

            // Set nasc url to pretendo
            nasc_url = nascUrl.ToCharArray();
